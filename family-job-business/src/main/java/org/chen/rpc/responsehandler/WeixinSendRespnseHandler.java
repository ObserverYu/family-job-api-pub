...
@Slf4j
public class WeixinSendRespnseHandler extends DefaultBusinessCodeHandler<SendMsgDto,Object> {

    @Override
    public void handle(OkHttpResponseUtils.BaseErrorHandleResult baseErrorHandleResult, OkHttpResponseUtils.JsonResult<SendMsgDto,Object> allResult, Object param, String apiName) {
    ...
    @Override
    public String getCode(OkHttpResponseUtils.JsonResult<SendMsgDto,Object> allResult) {
        SendMsgDto jsonRes = allResult.getJsonRes();
        return jsonRes.getErrcode();
    }

    @Override
    public String getMsg(OkHttpResponseUtils.JsonResult<SendMsgDto,Object> allResult) {
        SendMsgDto jsonRes = allResult.getJsonRes();
