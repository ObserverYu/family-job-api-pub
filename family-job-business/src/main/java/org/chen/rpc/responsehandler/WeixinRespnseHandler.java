...
@Slf4j
public class WeixinRespnseHandler extends DefaultBusinessCodeHandler<WeixinSessionDto,Object> {

    @Override
    public void handle(OkHttpResponseUtils.BaseErrorHandleResult baseErrorHandleResult, OkHttpResponseUtils.JsonResult<WeixinSessionDto,Object> allResult, Object param, String apiName) {
    ...
    @Override
    public String getCode(OkHttpResponseUtils.JsonResult<WeixinSessionDto,Object> allResult) {
        WeixinSessionDto jsonRes = allResult.getJsonRes();
        return jsonRes.getErrcode();
    }

    @Override
    public String getMsg(OkHttpResponseUtils.JsonResult<WeixinSessionDto,Object> allResult) {
        WeixinSessionDto jsonRes = allResult.getJsonRes();
